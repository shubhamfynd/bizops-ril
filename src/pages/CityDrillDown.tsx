...
import { ChevronLeft, TrendingUp, TrendingDown, Filter, ChevronRight, Home, MapPin, Sparkles, Calendar, RotateCcw, FileText, AlertTriangle, Target, Users, X } from "lucide-react";
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            {storeData.map((data, index) => (
              <div key={index} className={`bg-white rounded-xl p-4 shadow-sm border-l-4 aspect-square flex flex-col justify-between ${getBorderColor(data.ragStatus)} cursor-pointer hover:shadow-md transition-all duration-300 hover:scale-105 animate-fade-in-up`} style={{ animationDelay: `${index * 0.1}s` }}>
                <div>
